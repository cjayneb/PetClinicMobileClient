...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XPetClinic_MobileFrontend.Android.dll" comes first in this list. */
		"XPetClinic_MobileFrontend.Android.dll",
		"FFImageLoading.dll",
